...
namespace InternetShop.Data.EF.Migrations
{
    ...
    [Migration("20220129035637_FullTextSearch")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternetShop.Data.BookDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InternetShop.Data.OrderDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InternetShop.Data.OrderItemDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OtderItems");
                });

            modelBuilder.Entity("InternetShop.Data.OrderItemDto", b =>
                {
                    b.HasOne("InternetShop.Data.OrderDto", "Order")
                        .WithMany("Items")
